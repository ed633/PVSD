...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Student student3 = new Student("Selena" , 4.0);
        Student student4 = new Student("Maya" , 3.8);
        Student student5 = new Student("Hannah" , 4.5);
        Student student6 = new Student("Kamryn" , 4.2);
        Student student7 = new Student("Ava" , 5.0);
